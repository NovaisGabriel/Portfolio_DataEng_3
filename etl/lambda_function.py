...
def handler(event, context):
    ...
    cluster_id = client.run_job_flow(
                Name='EMR-Gabriel-delta',
                ServiceRole='EMR_DefaultRole',
                JobFlowRole='EMR_EC2_DefaultRole',
                VisibleToAllUsers=True,
                LogUri='s3://datalake-gabriel-tf/emr-logs',
                ...
                Steps=[{
                    ...
                    'HadoopJarStep': {
                        ...
                        'Args': ['spark-submit',
                                 ...
                                 '--master', 'yarn',
                                 '--deploy-mode', 'cluster',
                                 's3://datalake-gabriel-tf/emr-code/pyspark/01_delta_spark_insert.py'
                                 ]
                    }
                },
                {
                    ...
                    'HadoopJarStep': {
                        ...
                        'Args': ['spark-submit',
                                 ...
                                 '--master', 'yarn',
                                 '--deploy-mode', 'cluster',
                                 's3://datalake-gabriel-tf/emr-code/pyspark/02_delta_spark_upsert.py'
                                 ]
                    }
                }],
            )
